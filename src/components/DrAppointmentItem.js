...
import { convertAppointmentDate, parseAppointmentEndDate } from "../utils/ConvertDate"
import Appointment_API from "../API/Appointment_API"
import { useAuth } from "../AuthProvider"

const DoctorAppointmentItem = ({ appointmentKey, item, navigation, filter }) => {
    ...
    const completeAppointment = async (appointmentId) => {
        try {
            const cancel = await Appointment_API.soft_delete_Appointment(appointmentId)
