                ...
                {doctors.map((doctor, index) => (
                    <View key={index} style={styles.doctorContainer}>
                        ...
                        <View style={styles.buttonContainer}>
                            ...
                            <TouchableOpacity style={styles.iconButton} onPress={() => navigation.navigate('AppointmentDetail')}>
                            ...
                            <TouchableOpacity style={styles.iconButton} onPress={() => navigation.navigate('SettingAccount')}>
