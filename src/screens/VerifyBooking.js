...
import { formatDate, formatToDDMMYYYY, translateDayOfWeek } from "../utils/ConvertDate"
...
const VerifyBooking = ({ navigation, route }) => {
    ...
    const { region, specialty, doctor, medicalHistory, healthStatus, time } = route.params
                ...
                <View style={styles.problemContainer}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(val) => setInsurance({ ...insurance, number: val })}
                        />
                    </View>
                    <View style={styles.infoRow}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(val) => setInsurance({ ...insurance, location: val })}
                        />
                    </View>
                    {/* <View style={styles.infoRow}>
            ...
            />
                ...
                {account.underlying_condition !== "none" && (
                    <View style={styles.problemContainer}>
                        ...
                        <Text style={styles.problemText}>- {account.underlying_condition}</Text>
                    </View>
                )}
