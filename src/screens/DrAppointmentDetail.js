...
import { formatAppoinmentDateToDayOfWeek, formatAppoinmentDateToNTN } from "../utils/ConvertDate"
            ...
            <ScrollView>
                    ...
                    <View style={styles.doctorCard}>
                        ...
                        <View style={styles.doctorDetails}>
                            ...
                            <Text style={styles.specialty}>
                                {account?.speciality_id?.name} khu vực {account?.region_id?.name}
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.appointmentInfo}>
                    <View style={styles.dateContainer}>
                        ...
                        <Text style={styles.timeText}>
                            ...
                            {appoinment.appointment_time_start} - {appoinment.appointment_time_end}
                        </Text>
                    </View>
                ...
                {user.underlying_condition !== "none" && (
                    <View style={styles.problemContainer}>
                        ...
                        <Text style={styles.problemText}>- {user.underlying_condition}</Text>
                    </View>
                )}
